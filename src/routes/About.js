...
import abt from "../assets/home.jpg"
function About() {
    ...
    return (
        <>
            ...
            <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
                <p className=" text-2xl text-indigo-700 font-extrabold cursor-pointer pb-[100px] ">About</p>
                <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
                    <div className="w-full lg:w-6/12">
                        <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">We are here to make great  Business Strategy, Business Process Engineering, Platform Development, and Advocacy.</h2>
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6">
                        Agventure Consultancy was founded with a vision to provide top-notch consultancy services in the areas of Business Strategy, Business Process Engineering, Platform Development, and Advocacy. With a team of experienced professionals, we have been helping businesses across industries achieve their goals and drive growth since 2010.
                        </p>
                    </div>
                    <div className="w-full lg:w-6/12">
                        <img className="lg:block hidden w-full" src={abt} alt="people discussing on board" />
                        <img className="lg:hidden sm:block hidden w-full" src={abt} alt="people discussing on board" />
                        <img className="sm:hidden block w-full" src={abt} alt="people discussing on board" />
                    </div>
                </div>
                ...
                <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
                    ...
                    <div className="w-full lg:w-6/12">
                        <h2 className="font-bold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 md:mr-[130px]">Our Mission</h2>
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">
                        Agventure Consultancy was founded in 2010 with a vision to provide innovative solutions and strategic consulting services to businesses in the agriculture industry. Over the years, we have helped numerous clients navigate the complexities of the agribusiness sector and achieve sustainable growth.
                        </p>
                        <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10">
                        Our mission at Agventure Consultancy is to empower agribusinesses with tailored strategies, streamlined processes, cutting-edge platform development, and effective advocacy. We are committed to driving positive change and creating value for our clients through our expertise and dedication to excellence.
                        </p>
                    </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
                            ...
                            <div className="flex p-4 shadow-md">
                                ...
                                <div className="">
                                    ...
                                    Our team at Agventure Consultancy is comprised of experienced professionals with diverse backgrounds in agriculture, business strategy, process engineering, and advocacy. We bring a wealth of knowledge and industry insights to every project, ensuring that our clients receive the highest quality of service and support.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex p-4 shadow-md">
                                ...
                                <div className="">
                                    <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800">Achievements</p>
                                    <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                                    Over the years, Agventure Consultancy has successfully collaborated with leading businesses to drive growth, increase efficiency, and enhance market competitiveness. Our track record of success speaks for itself, with numerous satisfied clients and a reputation for excellence in the industry.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex p-4 shadow-md">
                                ...
                                <div className="">
                                    <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800">Offerings</p>
                                    <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                                    Whether you are looking to optimize your operations, expand into new markets, or navigate regulatory challenges, our team is here to help you achieve your goals.
                                    </p>
                                </div>
                            </div>
                        </div>
