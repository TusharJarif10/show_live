...
function Contact (){
    ...
    return (
        ...
        <div className="bg-gradient-to-b from-green-700 to-indigo-600 h-[55rem] w-full pt-10 md:h-[60rem] sm:h-[67rem]">
           
            <div className="w-full flex items-center justify-center my-12 ">

                <form ref={form} onSubmit={sendEmail}  className="absolute top-40 bg-white shadow rounded py-12 lg:px-28 px-8">
                    
                    <p className="md:text-3xl text-xl font-bold leading-7 text-center text-gray-700">CONTACT WITH US</p>
                        ...
                        <div className="md:w-72 flex flex-col">
                            ...
                            <input tabIndex={0} type="text" name="user_name" className="text-base leading-none
                             text-gray-900 p-3 focus:oultine-none focus:border-indigo-700 mt-4
                              bg-gray-100 border rounded border-gray-200 placeholder-gray-100" placeholder="Please input  name" />
                        </div>
                        <div className="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4">
                            <label className="text-base font-semibold leading-none text-gray-800">Email Address</label>
                            <input tabIndex={0} type="email" name="user_email" className="text-base leading-none
                             text-gray-900 p-3 focus:oultine-none focus:border-indigo-700 mt-4
                              bg-gray-100 border rounded border-gray-200 placeholder-gray-100" placeholder="Please input email address" />
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="w-full flex flex-col mt-8">
                            ...
                            <textarea tabIndex={0} role="textbox" type="text" name="message" className="h-36 text-base leading-none
                             text-gray-900 p-3 focus:oultine-none focus:border-indigo-700 mt-4
                              bg-gray-100 border rounded border-gray-200 placeholder-gray-100 resize-none" defaultValue={""} />
                            {/* <input type="submit" value="Send" /> */}
                        </div>
                    </div>
                    <p className="text-xs leading-3 text-gray-600 mt-4">By clicking submit you agree to our terms of service, privacy policy and how we use data as stated</p>
                    <div className="flex items-center justify-center w-full">
                        <button type="submit" value="Send" className="mt-9 text-base font-semibold leading-none text-white py-4 px-10
                         bg-indigo-700 rounded hover:bg-indigo-600 focus:ring-2 focus:ring-offset-2
